...
namespace ExpressWpfApp5
{
    ...
    partial class Papa
    {
        ...
        public static void MyDelete(string fName)
        {
            ...
            {
                File.Delete(fName);
                SayDarkGray("delete " + fName);
            }
            catch { Sos("err delete ", fName); }
            #endregion
        }
        ...
        public static void MoveOneFile(string oldName, string newName)
        {
            ...
            try
            {
                ...
                SayBlue(" Moved " + newName);
            }
            catch { Alarm("Error movie", newName); }
            #endregion
        }
        ...
        public static void CopyOneFile(string oldName, string newName)
        {
            ...
            try
            {
                ...
                SayBlue(" Coyed " + newName);
            }
            catch { Alarm("Error copy", newName); }
            #endregion
        }
