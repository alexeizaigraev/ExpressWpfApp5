    ...
    partial class Papa
    {
        ...
        protected static void OpenNote(string fileName)
        {
            ...
            */
            ...
            catch { Process.Start("notepad.exe", fileName); }
            #endregion
        }
        ...
        public static void TextToFile(string fName, string text)
        {
            ...
            catch { Sos("Error TextToFile", fName); }
            #endregion
        }
        ...
        public static List<string[]> FileToArr(string fName)
        {
            ...
            catch { Sos("Error FileToArr", fName); }
            return arr;
            #endregion
        }
        ...
        public static string FileToText(string fName)
        {
            ...
            catch { Sos("Error FileToText", fName); }
            return text;
            #endregion
        }
        ...
        public static Dictionary<string, string> MkComonHash(int keyColNum)
        {
            ...
            catch { Sos("Error чтения", myDataPath); }
            ...
            catch { Sos("Error MkComonHash", String.Format("KeyColNum {0}", keyColNum)); }
            return rez;
            #endregion
        }
